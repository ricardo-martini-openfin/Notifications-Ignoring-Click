...
exports.install = exports.getRuntimePath = exports.download = exports.getUrl = void 0;
const fs = require("fs");
...
async function download(version, folder, osConfig) {
    ...
    await http_1.downloadFile(url, file);
...
async function launch(config, osConfig) {
    try {
        ...
        if (typeof config.services !== 'undefined' && config.services !== null) {
            await services_1.startServices(config.services);
        }
