...
const external_window_1 = require("../external-window");
const webcontents_1 = require("../webcontents");
...
class _Window extends webcontents_1.WebContents {
    ...
    createWindow(options) {
        try {
            this.wire.sendAction('window-create-window', this.identity);
        }
        catch (e) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const windowCreation = this.wire.environment.electronChildWindows
                ? this.wire.environment.createChildContent({ entityType: EntityType_1.default.WINDOW, options })
                : this.wire.environment.createChildWindow(options);
    ...
    async getLayout() {
        try {
            this.wire.sendAction('window-get-layout', this.identity);
        }
        catch (e) {
            // don't expose
        }
    ...
    getParentApplication() {
        try {
            this.wire.sendAction('window-get-parent-application', this.identity);
        }
        catch (e) {
            // we do not want to expose this error, just continue if this analytics-only call fails
        }
    ...
    getParentWindow() {
        try {
            this.wire.sendAction('window-get-parent-window', this.identity);
        }
        catch (e) {
            // we do not want to expose this error, just continue if this analytics-only call fails
        }
    ...
    getWebWindow() {
        try {
            this.wire.sendAction('window-get-web-window', this.identity);
        }
        catch (e) {
            // we do not want to expose this error, just continue if this analytics-only call fails
        }
    ...
    isMainWindow() {
        try {
            this.wire.sendAction('window-is-main-window', this.identity);
        }
        catch (e) {
            // we do not want to expose this error, just continue if this analytics-only call fails
        }
