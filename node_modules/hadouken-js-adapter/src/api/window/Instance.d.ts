...
import { AnchorType, Transition, TransitionOptions } from '../../shapes/shapes';
import { WindowOption } from './windowOption';
import { WebContents } from '../webcontents';
import { FrameInfo, WindowInfo, WindowMovementOptions } from './shapes';
/**
...
export declare class _Window extends WebContents<WindowEvents> {
     ...
     */
    createWindow(options: WindowOption): Promise<OpenFin.Window>;
     ...
     */
    getGroup(): Promise<Array<OpenFin.Window | OpenFin.ExternalWindow>>;
    /**
     ...
     */
    joinGroup(target: OpenFin.Window | OpenFin.ExternalWindow): Promise<void>;
    /**
     ...
     */
    mergeGroups(target: OpenFin.Window | OpenFin.ExternalWindow): Promise<void>;
    /**
     ...
     */
    setBounds(bounds: Partial<OpenFin.Bounds>, options?: WindowMovementOptions): Promise<void>;
    /**
